...
export function FeaturedVideo({ onNavigate }: Props) {
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="border border-[#00f0ff]/30 p-6 sm:p-8 lg:p-10 bg-[#0a0e14]/50 backdrop-blur-sm transition-all duration-300 hover:border-[#00f0ff]/60 hover:shadow-[0_0_20px_rgba(0,240,255,0.3)]">
          {/* Section Header */}
          <div className="mb-8">
            <p className="text-[#00ff88] text-xs sm:text-sm tracking-[0.3em] mb-2">[ SECTION 03 ]</p>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">VIDEO.PROJECTS</h2>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-white font-bold text-base sm:text-lg mb-1 tracking-wide">
                  Lihat Semua Video Project
                </p>
                <p className="text-gray-400 text-xs sm:text-sm">
                  Dokumentasi & showcase project networking, web dev, dan cybersecurity
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 text-[#00f0ff] text-sm tracking-widest flex-shrink-0">
              <span className="hidden sm:inline opacity-60 group-hover:opacity-100 transition-opacity">ACCESS_LOG</span>
